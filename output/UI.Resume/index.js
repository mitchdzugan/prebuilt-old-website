                                            ...
                                            return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Reader_Trans.bindReaderT(Data_Identity.bindIdentity))(Impulse_DOM_Tags.div_(Impulse_DOM_Attrs.className("modal-content"))(Impulse_DOM_API.keyed("modalVod " + Data_Show.show(Data_Show.showInt)(vodIndex))(Impulse_DOM_Tags.div_(Impulse_DOM_Attrs.className("card"))(Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Reader_Trans.bindReaderT(Data_Identity.bindIdentity))(Impulse_DOM_Tags.div_(Impulse_DOM_Attrs.className("card-content"))(Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Reader_Trans.bindReaderT(Data_Identity.bindIdentity))(Impulse_DOM_Tags.video_(Control_Apply.applySecond(Control_Monad_State_Trans.applyStateT(Data_Identity.monadIdentity))(Impulse_DOM_Attrs.className("video-content"))(Impulse_DOM_Attrs.controls(true)))(Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Reader_Trans.bindReaderT(Data_Identity.bindIdentity))(Impulse_DOM_Tags.source_(Control_Apply.applySecond(Control_Monad_State_Trans.applyStateT(Data_Identity.monadIdentity))(Impulse_DOM_Attrs.src(m_vod.value0.vod))(Impulse_DOM_Attrs.attr_type("video/mp4")))(Impulse_DOM_API.dnil))(function () {
                                                ...
                                                return Impulse_DOM_Tags.div_(Impulse_DOM_Attrs.className("card-footer"))(Impulse_DOM_Tags.div_(Impulse_DOM_Attrs.className("card-footer-item"))(Impulse_DOM_Tags.div_(Impulse_DOM_Attrs.className("buttons has-addons"))(Control_Bind.bind(Control_Monad_Reader_Trans.bindReaderT(Data_Identity.bindIdentity))(Impulse_DOM_Tags.button(Control_Apply.applySecond(Control_Monad_State_Trans.applyStateT(Data_Identity.monadIdentity))(Impulse_DOM_Attrs.className("button"))(Impulse_DOM_Attrs.disabled(isFirst)))(Impulse_DOM_Tags.span_(Impulse_DOM_Attrs.className("icon is-large"))(Impulse_DOM_Tags.i_(Impulse_DOM_Attrs.className("fas fa-caret-left"))(Impulse_DOM_API.dnil))))(function (d_prev) {
                                                    return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Reader_Trans.bindReaderT(Data_Identity.bindIdentity))(Impulse_Util_Foldable.forMi_(Control_Monad_Reader_Trans.monadRecReaderT(Control_Monad_Rec_Class.monadRecIdentity))(Data_Foldable.foldableArray)(vods)(function (ind) {
                                                        return function (v) {
                                                            return Impulse_DOM_API.keyed("vodSel " + Data_Show.show(Data_Show.showInt)(ind))(Control_Bind.bind(Control_Monad_Reader_Trans.bindReaderT(Data_Identity.bindIdentity))(Impulse_DOM_Tags.button(Impulse_DOM_Attrs.className("button"))(Impulse_DOM_Tags.span_((function () {
                                                                var $8 = ind === vodIndex;
                                                                if ($8) {
                                                                    return Impulse_DOM_Attrs.className("has-text-dark");
                                                                };
                                                                return Impulse_DOM_Attrs.className("has-text-grey-lighter");
                                                            })())(Impulse_DOM_API.text("\u2022"))))(function (d_sel) {
    ...
    return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Reader_Trans.bindReaderT(Data_Identity.bindIdentity))(Impulse_DOM_Tags.section_(Impulse_DOM_Attrs.className("section"))(Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Reader_Trans.bindReaderT(Data_Identity.bindIdentity))(Impulse_DOM_Tags.h2_(Impulse_DOM_Attrs.id("education"))(Impulse_DOM_API.text("Education")))(function () {
        ...
        return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Reader_Trans.bindReaderT(Data_Identity.bindIdentity))(Impulse_DOM_Tags.section_(Impulse_DOM_Attrs.className("section"))(Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Reader_Trans.bindReaderT(Data_Identity.bindIdentity))(Impulse_DOM_Tags.h2_(Impulse_DOM_Attrs.id("work-exp"))(Impulse_DOM_API.text("Technical Work Experience")))(function () {
            ...
            return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Reader_Trans.bindReaderT(Data_Identity.bindIdentity))(Impulse_DOM_Tags.section_(Impulse_DOM_Attrs.className("section"))(Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Reader_Trans.bindReaderT(Data_Identity.bindIdentity))(Impulse_DOM_Tags.h2_(Impulse_DOM_Attrs.id("projects"))(Impulse_DOM_API.text("Personal Project Work")))(function () {
                ...
                return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Reader_Trans.bindReaderT(Data_Identity.bindIdentity))(Impulse_DOM_Tags.section_(Impulse_DOM_Attrs.className("section"))(Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Reader_Trans.bindReaderT(Data_Identity.bindIdentity))(Impulse_DOM_Tags.h2_(Impulse_DOM_Attrs.id("etc"))(Impulse_DOM_API.text("Honors, Awards, and Involvements")))(function () {
...
var navItem = function (topId) {
    return function (v) {
        return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Reader_Trans.bindReaderT(Data_Identity.bindIdentity))(Impulse_DOM_Tags.div_(Impulse_DOM_Attrs.className("navItem"))(Control_Bind.bind(Control_Monad_Reader_Trans.bindReaderT(Data_Identity.bindIdentity))(Impulse_DOM_Tags.div(Impulse_DOM_Attrs.classNames(Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Impulse_DOM_Attrs.cn("navLink"))(function () {
            return Control_Monad.whenM(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity))(Control_Applicative.pure(Control_Monad_State_Trans.applicativeStateT(Data_Identity.monadIdentity))(v.id === topId))(Impulse_DOM_Attrs.cn("has-text-weight-bold"));
        })))(Impulse_DOM_API.text(v.title)))(function (navLink) {
            return Control_Bind.bind(Control_Monad_Reader_Trans.bindReaderT(Data_Identity.bindIdentity))(Impulse_DOM_API["_eff"](Impulse_FRP_Event.consume(function (v1) {
                return Scroll.scrollToId(v.id);
            })(Impulse_DOM_ImpulseEl.onClick(navLink))))(function () {
                return Impulse_Util_Foldable.forM_(Control_Monad_Reader_Trans.monadRecReaderT(Control_Monad_Rec_Class.monadRecIdentity))(Data_Foldable.foldableArray)(v.children)(navItem(topId));
            });
        })))(function () {
            return Control_Applicative.pure(Control_Monad_Reader_Trans.applicativeReaderT(Data_Identity.applicativeIdentity))(Data_Unit.unit);
        });
    };
};
var resumeNav = Impulse_DOM_Tags.div_(Impulse_DOM_Attrs.className("content nav-content"))(Impulse_DOM_Tags.div_(Impulse_DOM_Attrs.className("navWrapper"))((function () {
    var e_topId = Impulse_FRP_Event.mkEvent(Scroll.attachScrollWatch);
    return Control_Bind.bind(Control_Monad_Reader_Trans.bindReaderT(Data_Identity.bindIdentity))(Impulse_DOM_API["_eff"](Scroll.getTopId))(function (initTopId) {
        return Control_Bind.bind(Control_Monad_Reader_Trans.bindReaderT(Data_Identity.bindIdentity))(Impulse_DOM_API.s_use(Control_Bind.bindFlipped(Control_Monad_Reader_Trans.bindReaderT(Data_Identity.bindIdentity))(Impulse_FRP_Signal.s_dedup(Data_Eq.eqString))(Impulse_FRP_Signal.s_from(e_topId)(initTopId))))(function (s_topId) {
            return Impulse_DOM_API.s_bindDOM_(s_topId)(function (topId) {
                return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Reader_Trans.bindReaderT(Data_Identity.bindIdentity))(navItem(topId)({
                    title: "Education",
                    id: "education",
                    children: [  ]
                }))(function () {
                    return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Reader_Trans.bindReaderT(Data_Identity.bindIdentity))(navItem(topId)({
                        ...
                        return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Reader_Trans.bindReaderT(Data_Identity.bindIdentity))(navItem(topId)({
                            ...
                            return navItem(topId)({
                                title: "Honors, Awards, and Involvements",
                                id: "etc",
                                children: [  ]
                            });
                        });
...
var resume = Impulse_DOM_Tags.div_(Impulse_DOM_Attrs.className("resume-page"))(Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Reader_Trans.bindReaderT(Data_Identity.bindIdentity))(Impulse_DOM_Tags.div_(Impulse_DOM_Attrs.className("resume-nav"))(resumeNav))(function () {
    return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Reader_Trans.bindReaderT(Data_Identity.bindIdentity))(resumeContent)(function () {
        return Impulse_DOM_Tags.div_(Impulse_DOM_Attrs.className("resume-nav"))(Impulse_DOM_API.dnil);
    });
}));
module.exports = {
    p_modal: p_modal,
