                                                ...
                                                return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Reader_Trans.bindReaderT(Data_Identity.bindIdentity))(renderSection({
                                                    ...
                                                    return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Reader_Trans.bindReaderT(Data_Identity.bindIdentity))(renderSection({
                                                        ...
                                                        return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Reader_Trans.bindReaderT(Data_Identity.bindIdentity))(renderSection({
                                                            ...
                                                            ps: "\x0ap_counter = SProxy :: SProxy \"counter\"\x0a\x0achangeScoreButton :: forall e c. Int -> String -> DOM e { counter :: Collector Int | c } Unit\x0achangeScoreButton change message = do\x0a\x09d_button <- button anil $ text message\x0a\x09e_emit p_counter $ onClick d_button <#> const change\x0a\x0adisplayScore :: forall e c. DOM { counter :: FRP.Signal Int | e } c Unit\x0adisplayScore = do\x0a\x09s_counter <- getEnv p_counter\x0a\x09s_bindDOM_ s_counter \\counter -> do\x0a\x09\x09text $ \"Points: \" <> (show counter)\x0a\x0aui8 :: forall e c. DOM e c Unit\x0aui8 = do\x0a\x09e_collectAndReduce p_counter (\\agg change -> agg + change) 0 do\x0a\x09\x09changeScoreButton   1  \"Click for (+1)\"\x0a\x09\x09displayScore\x0a\x09\x09changeScoreButton (-1) \"Click for (-1)\"\x0a"
                                                        }))(function () {
                                                            return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Reader_Trans.bindReaderT(Data_Identity.bindIdentity))(renderSection({
                                                                title: new Data_Maybe.Just("d_stash(drawChildren) => ImpulseStash / d_apply(impulseStash)"),
                                                                preCode: Impulse_DOM_API.dnil,
                                                                postCode: Impulse_DOM_Tags.p_(Impulse_DOM_Attrs.anil)(Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Reader_Trans.bindReaderT(Data_Identity.bindIdentity))(Impulse_DOM_Tags.span_(Impulse_DOM_Attrs.className("pre"))(Impulse_DOM_API.text("d_stash")))(function () {
                                                                    return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Reader_Trans.bindReaderT(Data_Identity.bindIdentity))(Impulse_DOM_API.text(" will store the rendered content in a value that can be rendered in a different location in DOM via "))(function () {
                                                                        return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Reader_Trans.bindReaderT(Data_Identity.bindIdentity))(Impulse_DOM_Tags.span_(Impulse_DOM_Attrs.className("pre"))(Impulse_DOM_API.text("d_apply")))(function () {
                                                                            return Impulse_DOM_API.text(". This is especially useful when you need to render content in a place that doesn't have all of the necessary context needed to calculate the UI. For example if you want to trigger a notification from a place deep within the UI with content that depends on state that is local to that area of the UI, but need the notification DOM element to exist higher in the DOM tree, you can render it within a stash from the place with all the context, and bubble up the resulting notification to be applied at the point in DOM that makes the most sense.");
                                                                        });
                                                                    });
                                                                })),
                                                                code: Impulse_DOM_Tags.ul_(Impulse_DOM_Attrs.anil)(Control_Bind.bind(Control_Monad_Reader_Trans.bindReaderT(Data_Identity.bindIdentity))(Impulse_DOM_API.d_stash(Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Reader_Trans.bindReaderT(Data_Identity.bindIdentity))(Impulse_DOM_Tags.li_(Impulse_DOM_Attrs.anil)(Impulse_DOM_API.text("out")))(function () {
                                                                    return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Reader_Trans.bindReaderT(Data_Identity.bindIdentity))(Impulse_DOM_Tags.li_(Impulse_DOM_Attrs.anil)(Impulse_DOM_API.text("of")))(function () {
                                                                        return Impulse_DOM_Tags.li_(Impulse_DOM_Attrs.anil)(Impulse_DOM_API.text("order?"));
                                                                    });
                                                                })))(function (stash) {
                                                                    return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Reader_Trans.bindReaderT(Data_Identity.bindIdentity))(Impulse_DOM_Tags.li_(Impulse_DOM_Attrs.anil)(Impulse_DOM_API.text("You")))(function () {
                                                                        return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Reader_Trans.bindReaderT(Data_Identity.bindIdentity))(Impulse_DOM_Tags.li_(Impulse_DOM_Attrs.anil)(Impulse_DOM_API.text("thought")))(function () {
                                                                            return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Reader_Trans.bindReaderT(Data_Identity.bindIdentity))(Impulse_DOM_Tags.li_(Impulse_DOM_Attrs.anil)(Impulse_DOM_API.text("this")))(function () {
                                                                                return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Reader_Trans.bindReaderT(Data_Identity.bindIdentity))(Impulse_DOM_Tags.li_(Impulse_DOM_Attrs.anil)(Impulse_DOM_API.text("was")))(function () {
                                                                                    return Impulse_DOM_API.d_apply(stash);
                                                                                });
                                                                            });
                                                                        });
                                                                    });
                                                                })),
                                                                js: "\x0aconst ui9 = (I) => {\x0a\x09I.ul({}, (I) => {\x0a\x09\x09const stash = I.d_stash((I) => {\x0a\x09\x09\x09I.li({}, (I) => I.text(\"out\"));\x0a\x09\x09\x09I.li({}, (I) => I.text(\"of\"));\x0a\x09\x09\x09I.li({}, (I) => I.text(\"order?\"));\x0a\x09\x09});\x0a\x09\x09I.li({}, (I) => I.text(\"You\"));\x0a\x09\x09I.li({}, (I) => I.text(\"thought\"));\x0a\x09\x09I.li({}, (I) => I.text(\"this\"));\x0a\x09\x09I.li({}, (I) => I.text(\"was\"));\x0a\x09\x09I.d_apply(stash);\x0a\x09});\x0a};\x0a",
                                                                ps: "\x0aui9 :: forall e c. DOM e c Unit\x0aui9 = do\x0a\x09ul_ anil do\x0a\x09\x09stash <- d_stash do\x0a\x09\x09\x09li_ anil $ text \"out\"\x0a\x09\x09\x09li_ anil $ text \"of\"\x0a\x09\x09\x09li_ anil $ text \"order?\"\x0a\x09\x09li_ anil $ text \"You\"\x0a\x09\x09li_ anil $ text \"thought\"\x0a\x09\x09li_ anil $ text \"this\"\x0a\x09\x09li_ anil $ text \"was\"\x0a\x09\x09d_apply stash\x0a"
                                                            }))(function () {
